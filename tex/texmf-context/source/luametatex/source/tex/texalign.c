...
static void tex_aux_finish_align(void)
{
    ...
    */
    if (cur_list.mode == internal_vmode) {
        ...
        overfull_rule_par = 0; 
        preroll = tex_hpack(preamble, saved_align_amount, saved_align_mode, direction_unknown, holding_none_option);
        ...
        /* why filtered here ... */
        preroll = tex_filtered_vpack(preamble, saved_align_amount, saved_align_mode, max_depth_par, preamble_group, direction_unknown, 0, 0, 0, holding_none_option, NULL);
